                        ...
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                return _context.abrupt('return', Nova.request().post('/nova-api/' + this.resourceName + '/' + this.resourceId, formData).then(function () {
                                    ...
                                    _this.id = _this.resourceId;
                                    _this.$toasted.show(_this.field.successMessage, { type: 'success' });
                                }, function (response) {
                                    _this.value = _this.field.value;
                                    _this.$toasted.show(_this.field.errorMessage ? _this.field.errorMessage : response, { type: 'error' });
                                }));
...
/* harmony default export */ __webpack_exports__["a"] = ({
    methods: {
        backgroundColor: function backgroundColor() {
            if (this.field.colorMap != undefined) {

                var value = this.field.colorMap[this.field.value];

                if (value != null && value.hasOwnProperty('background')) {
...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-inline', __webpack_require__(7));
    Vue.component('detail-inline', __webpack_require__(13));
    Vue.component('form-inline', __webpack_require__(16));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers_init__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_inline__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers_colors__ = __webpack_require__(4);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_0_laravel_nova__["FormField"], __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["HandlesValidationErrors"], __WEBPACK_IMPORTED_MODULE_2__helpers_inline__["a" /* default */], __WEBPACK_IMPORTED_MODULE_1__helpers_init__["a" /* default */], __WEBPACK_IMPORTED_MODULE_3__helpers_colors__["a" /* default */]],
    ...
    ? _c("div", { staticClass: "relative flex items-stretch" }, [
        _c("label", [
          _c("input", {
            ...
            staticClass:
              "w-full form-control form-input form-input-bordered inline-field p-0 text-center whitespace-no-wrap",
            attrs: {
              id: _vm.field.name,
              type: "text",
        ...
        _c("div", { staticClass: "inline-flex" }, [
          _vm.field.textOnIndex
            ...
            : _c(
                ...
                {
                  staticClass:
                    "flex w-auto text-center py-2 m-1 badge-container"
                },
                [
                  _vm.field.colorMap
                    ? _c("span", {
                        staticClass:
                          "whitespace-no-wrap px-2 py-1 rounded-full text-xs font-bold",
                        style: {
                    ...
                    : _c("span", {
                        staticClass: "whitespace-no-wrap text-center",
                        domProps: { innerHTML: _vm._s(_vm.field.value) }
                      })
                ]
              )
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_0_laravel_nova__["FormField"], __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["HandlesValidationErrors"], __WEBPACK_IMPORTED_MODULE_1__helpers_init__["a" /* default */], __WEBPACK_IMPORTED_MODULE_2__helpers_inline__["a" /* default */], __WEBPACK_IMPORTED_MODULE_3__helpers_colors__["a" /* default */]],
              ...
              [
                _c("label", [
                  _c("input", {
                    ...
                    staticClass:
                      "form-input inline-field pl-0 w-full whitespace-no-wrap",
                    attrs: {
                      id: _vm.field.name,
                      type: "text",
                      placeholder: _vm.field.name,
