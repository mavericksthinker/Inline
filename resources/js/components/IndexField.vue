<template>
    <div v-if="field.inlineIndex" slot="field">
        <div class="inline-flex">
            <div v-if="field.textOnIndex"
                 v-html="field.value"
                 class="flex-1 py-2 m-1"
                 :class="`text-${field.textAlign}`"
            >
            </div>
            <div class="flex-1 py-2 m-1">
                <label>
                    <input
                        type="text"
        ...
        <div class="absolute rotating text-80 justify-center items-center pin-y pin-r mr-3" v-show="loading">
    ...
    <div v-else>
        <div class="inline-flex">
            ...
            <div v-else class="flex-1 py-2 m-1 badges badge-container">
                <span
                        v-if="field.colorMap"
